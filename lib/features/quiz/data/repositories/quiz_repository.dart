...
class QuizRepository {
  ...
  static const List<QuizQuestionModel> defaultQuestions = [
    QuizQuestionModel(
      id: 'q_1_1',
      levelId: 1,
      questionText: 'What does the PASS acronym stand for when operating a portable fire extinguisher?',
      options: [
    ...
    QuizQuestionModel(
      id: 'q_1_2',
      levelId: 1,
      questionText: 'Which class of fire extinguisher is specifically designed for energized electrical equipment?',
    ...
    QuizQuestionModel(
      id: 'q_2_1',
      levelId: 2,
      questionText: 'What is the mandatory inspection frequency for self-contained breathing apparatus (SCBA) cylinders?',
    ...
    QuizQuestionModel(
      id: 'q_3_1',
      levelId: 3,
      questionText: 'What is the minimum required clearance space in front of electrical panels operating at 600V or less under NFPA 70?',
      options: ['24 inches of clear space', '30 inches of clear space', '36 inches of clear space', '48 inches of clear space'],
      correctOptionIndex: 2,
      nfpaCodeReference: 'NFPA 70 Section 110.26 Spaces About Electrical Equipment',
    ),
    QuizQuestionModel(
      id: 'q_3_2',
      levelId: 3,
      questionText: 'According to NFPA 10, how frequently must portable fire extinguishers undergo certified professional inspection?',
      options: ['Every 6 months', 'Annually (12 months)', 'Every 2 years', 'Every 5 years'],
      correctOptionIndex: 1,
    ...
    QuizQuestionModel(
      id: 'q_4_1',
      levelId: 4,
      questionText: 'What is the maximum allowable travel distance to an exit in a non-sprinklered industrial occupancy?',
    ...
    QuizQuestionModel(
      id: 'q_5_1',
      levelId: 5,
      questionText: 'In the NFPA 704 Diamond hazard identification system, what does the blue diamond represent?',
      options: ['Flammability', 'Health Hazard', 'Instability / Reactivity', 'Special Notice'],
      correctOptionIndex: 1,
  ...
  Future<List<QuizQuestionModel>> getQuestionsForLevel(int levelId) async {
    ...
    // If level has no questions, generate or fallback
    return _geminiService.generateFallbackQuestions('Level $levelId Standard Drills', levelId: levelId);
  }
  ...
  Future<List<QuizQuestionModel>> generateAndAddAiQuestions(String topic, int levelId) async {
    final newQuestions = await _geminiService.generateQuestionsFromTopic(topic, levelId: levelId);
    final all = await getAllQuestions();
